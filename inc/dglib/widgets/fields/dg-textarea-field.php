...
<p class="dg-widget-field-wrapper <?php echo esc_attr($dg_widget_field_wraper); ?>">
	...
	<textarea class="widefat <?php echo esc_attr($dg_widget_relation_class); ?>" rows="<?php echo absint( $dg_widget_field_row ); ?>" id="<?php echo esc_attr( $centurywidget->get_field_id( $dg_widget_field_name ) ); ?>" name="<?php echo esc_attr( $centurywidget->get_field_name( $dg_widget_field_name ) ); ?>" data-relations="<?php echo esc_attr($dg_widget_relation_json) ?>" ><?php echo esc_html( $dg_widget_field_value ); ?></textarea>
</p>