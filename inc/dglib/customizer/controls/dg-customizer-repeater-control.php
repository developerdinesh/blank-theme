...
if ( ! class_exists( 'Dglib_Customizer_Repeater_Control' )):
	...
	class Dglib_Customizer_Repeater_Control extends WP_Customize_Control{
		...
		public function enqueue(){
			...
			wp_enqueue_script('dg-customizer-repeater-control-js', dglib_directory_uri('assets/parts/controls/js/dg-customizer-repeater-control.min.js'), array('jquery'), '1.0.0', false);
